...
model_name = 'resnet20'
path1 = '/n/coxfs01/ybansal/main-exp/rep-compare-models/1ayqv8zl/final_model.pt'
path2 = '/n/coxfs01/ybansal/main-exp/rep-compare-models/nwg7094q/best_model.pt'
...
a = feature_ex(new_model1, torch.randn(4, 3, 32, 32).cuda(), 'resnet50_im', layer_ind=layer_index)
...
feature_ex_1 = lambda inp: feature_ex(new_model1, inp, 'resnet50_im', layer_ind=layer_index)
feature_ex_2 = lambda inp: feature_ex(new_model2, inp, 'resnet50_im', layer_ind=layer_index)

test_size = len(test_data)

test_features_1 = np.zeros((test_size, feature_size), dtype='float32')
test_features_2 = np.zeros((test_size, feature_size), dtype='float32')      
