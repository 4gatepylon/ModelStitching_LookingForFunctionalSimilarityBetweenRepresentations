...
from basicmodels import create_cnn, Flatten
...
wandb.init(project='cka-simclr', entity='yaminibansal')

layer_index = int(sys.argv[1])
layer_index2 = int(sys.argv[2])
model_name = 'resnet18k'
path1 = '/n/coxfs01/ybansal/main-exp/results/rep-compare-models/wbympzd6/final_model.pt'
path2 = '/n/coxfs01/ybansal/pretrain-rep/CIFAR-10/simclr_resnet18_28w562hk/28w562hk/last_layer_trained_model.pt'
...
b = feature_ex(new_model2, torch.randn(4, 3, 32, 32).cuda(), model_name, layer_ind=layer_index2)
