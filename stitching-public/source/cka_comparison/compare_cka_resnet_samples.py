...
wandb.init(project='cka-diff-width', entity='yaminibansal')

layer_index = int(sys.argv[1])
layer_index2 = int(sys.argv[2])
model_name = 'resnet18k'
path1 = '/n/coxfs01/ybansal/main-exp/results/rep-compare-models/96jnwblw/final_model.pt'
path2 = '/n/coxfs01/ybansal/main-exp/results/rep-compare-models/3db6566h/final_model.pt'
