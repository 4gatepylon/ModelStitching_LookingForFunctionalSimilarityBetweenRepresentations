...
class wideresnet_pic(nn.Module):
    def __init__(self, config):
        super(wideresnet_pic, self).__init__()
...
class wideresnet_wider(nn.Module):
    def __init__(self, config):
        super(wideresnet_pic, self).__init__()
...
class wideresnet_mine(nn.Module):
    def __init__(self, config):
        super(wideresnet_mine, self).__init__()
