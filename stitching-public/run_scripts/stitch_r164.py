...
model_stitch_counter = {
    '15 16 17 18': '/n/coxfs01/ybansal/main-exp/freezetrain-r164-stitchcounter/p4f1p7fr/best_model.pt',
    '70 71 72 73 74': '/n/coxfs01/ybansal/main-exp/freezetrain-r164-stitchcounter/btsbng5v/best_model.pt ',
    '50 51 52 53 54': '/n/coxfs01/ybansal/main-exp/freezetrain-r164-stitchcounter/b3mo1fcz/final_model.pt ',
    '30 to 65': '/n/coxfs01/ybansal/main-exp/freezetrain-r164-stitchcounter/is1d8q5b/final_model.pt '
...
def sgd_const():
    ...
    search.add_static_var("classifiername", 'resnet20')

    search.add_static_var("stitch_models", '')
    search.add_list("stitch_model1_path", [model_stitch_counter['30 to 65']])
    search.add_list("stitch_model2_path", [model_bad_cka['resnet164_init2']])
    search.add_list("stitch_layer_num", [40, 45, 50, 55])
...
#    search.add_list("stitch_no_bn", '')
    ...
    search.add_static_var("wandb_project_name", 'stitch-r164-counter')    
