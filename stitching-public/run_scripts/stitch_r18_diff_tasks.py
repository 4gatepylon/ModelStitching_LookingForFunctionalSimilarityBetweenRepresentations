...
def sgd_const():
    ...
    search.add_list("stitch_model1_path", [model_desc['resnet18_oa_init1'], model_desc_noise['resnet18_p01_init1'], model_desc_noise['resnet18_p05_init1']])
    search.add_list("stitch_model2_path", [model_desc['resnet18_init2']])
...
#    search.add_list("stitch_no_bn", '')
    ...
    search.add_static_var("wandb_project_name", 'stitch-r18-cf10-diff-tasks')    
