...
model_desc_noise = {
    ...
    'resnet18_p09_init1': '/n/coxfs01/ybansal/main-exp/rep-compare-models/29zghuz1/final_model.pt',
...
def sgd_const():
    ...
    search.add_list("stitch_model1_path", [model_desc['resnet18_init2']])
    search.add_list("stitch_model2_path", [model_desc['resnet18_simclr_init2']])
    ...
    search.add_static_var("wandb_project_name", 'stitch-r18-simclr')    
