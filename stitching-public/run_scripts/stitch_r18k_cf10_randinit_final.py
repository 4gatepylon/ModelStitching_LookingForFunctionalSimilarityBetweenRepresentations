...
def sgd_const():
    ...
    search.add_list("stitch_layer_num", [2, 3, 4, 5, 7])#stitch_indices['resnet18k_cifar'])
...
#    search.add_list("stitch_no_bn", '')
    ...
    search.add_static_var("wandb_project_name", 'stitch-cf10-randinit')    
