...
def sgd_const():
    ...
    search.add_list("stitch_model1_path", [model_diff_width['resnet18_w8_init1']])#, model_desc['resnet18_init1']]) #model_diff_width['resnet18_w4_init1'], model_diff_width['resnet18_w8_init1'], m  #, model_diff_width['resnet18_w128_init1']])
    search.add_list("stitch_model2_path", [model_diff_width['resnet18_w16_init1']])#, model_diff_width['resnet18_w128_init2']])
...
#    search.add_list("stitch_no_bn", '')
    ...
    search.add_static_var("wandb_project_name", 'stitch-cf10-diff-width-16v128')    
