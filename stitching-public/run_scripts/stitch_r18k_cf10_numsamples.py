...
def sgd_const():
    ...
    search.add_list("stitch_model1_path", [model_desc_numsamples['resnet18_5K_init1'], model_desc_numsamples['resnet18_10K_init1'], model_desc_numsamples['resnet18_25K_init1']])#, model_desc['resnet18_init1']])
    search.add_list("stitch_model2_path", [model_desc_numsamples['resnet18_10K_init2']])
...
#    search.add_list("stitch_no_bn", '')
    ...
    search.add_static_var("wandb_project_name", 'stitch-numsamples-kernel1')    
