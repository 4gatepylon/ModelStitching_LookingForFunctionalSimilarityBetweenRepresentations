...
module load cuda/11.0.3-fasrc01 cudnn/8.0.4.30_cuda11.0-fasrc01

source activate pta40
...
def sgd_const():
    ...
    search.add_list("stitch_model1_path", ['random_init'])
    search.add_list("stitch_model2_path", ['random_init', model_diff_width['resnet18_w16_init2']])
...
#    search.add_list("stitch_no_bn", '')
    ...
    search.add_static_var("wandb_project_name", 'stitch-cf10-random-baseline')    
