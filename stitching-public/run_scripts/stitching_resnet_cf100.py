...
model_desc = {
    ...
    'resnet18_oa_init1': '/n/coxfs01/ybansal/main-exp/rep-compare-models/1riyo69g/final_model.pt',
    'resnet18_oa_init2': '/n/coxfs01/ybansal/main-exp/rep-compare-models/caf6r2z8/final_model.pt',
    'resnet110_init1': '/n/coxfs01/ybansal/main-exp/rep-compare-models/9yh7pfxs/final_model.pt',
    'resnet110_init2': '/n/coxfs01/ybansal/main-exp/rep-compare-models/45r64ug4/final_model.pt',
    'cf100_resnet20_init1': '/n/coxfs01/ybansal/main-exp/rep-compare-models/8r0w6hzv/final_model.pt',
    'cf100_resnet20_init2': '/n/coxfs01/ybansal/main-exp/rep-compare-models/dne2gdan/final_model.pt',
    'cf100_resnet110_init1': '/n/coxfs01/ybansal/main-exp/rep-compare-models/djun6l6g/final_model.pt',
    'cf100_resnet110_init2': '/n/coxfs01/ybansal/main-exp/rep-compare-models/biktvxtk/final_model.pt'
}
...
def sgd_const():
    ...
    search.add_static_var("dataname", 'CIFAR100withInds')
    search.add_static_var("dataroot", '/n/coxfs01/ybansal/Datasets/CIFAR100')
    ...
    search.add_list("stitch_model1_path", [model_desc['cf100_resnet20_init1']])
    search.add_list("stitch_model2_path", [model_desc['cf100_resnet20_init2']])
    search.add_list("stitch_layer_num", [2, 4, 5, 6, 7, 8])
    search.add_list("stitch_kernel_size", [3])
    search.add_list("stitch_depth", [1])

    search.add_static_var("numout", 100)
    ...
    # search.add_static_var("lr", 0.5)
    # search.add_static_var("lr_drop_factor", 0.5)
    # search.add_static_var("lr_monitor", 'tr_acc')
    # search.add_static_var("lr_patience", 1500)

    
    search.add_static_var("total_iterations", 120000)
    search.add_static_var("tr_loss_thresh", 1e-6)

    search.add_static_var("wandb_project_name", 'model-stitching-resnet-cf100')    
